                        ...
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${context.watch<HomePageProvider>().user.name}',
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: '${context.read<HomePageProvider>().user.name}',
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          border: InputBorder.none,
                                          hintText: '${context.read<HomePageProvider>().user.nameEnglish}',
                                          suffixStyle: TextStyle(fontSize: 16.sp, fontFamily: FontFamily.bai_jamjuree),
                                          fillColor: AppColors.text,
                                        ),
                                        validator: (value) {
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText: '${context.read<HomePageProvider>().user.dOB}',
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          border: InputBorder.none,
                                          hintText: '${context.read<HomePageProvider>().user.position}',
                                          suffixStyle: TextStyle(fontSize: 16.sp, fontFamily: FontFamily.bai_jamjuree),
                                          fillColor: AppColors.text,
                                        ),
                                        validator: (value) {
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: profile.colorDropDownValue(context.read<HomePageProvider>().user.team.toString())),
                                      child: DropdownButtonFormField<String>(
                                        icon: const Icon(Icons.arrow_drop_down_rounded),
                                        hint: Text('${context.read<HomePageProvider>().user.team}'),
