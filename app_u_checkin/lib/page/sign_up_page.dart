                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: signUp.isActiveSignUp
                            ? () async {
                                signUp.saveDataAndNavigator(context);
                                // List<String> listKey = (await NPreferences().getDataString(ShareKeys.listUser)) as List<String>;
                                // if (signUp.rePasswordController.text == signUp.passwordController.text) {
                                //   User user = User();
                                //   setState(() {
                                //     user.id = DateTime.now().microsecondsSinceEpoch;
                                //     user.email = signUp.emailController.text;
                                //     user.password = signUp.passwordController.text;
